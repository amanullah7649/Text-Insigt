...
export class AnalyzerController {
    ...
    @Post("word-count")
    async getWordCount(@Body() payload: AnalyzerDto): Promise<number> {
        return await this.analyzerService.wordCount(payload);
    }

    @Post("characters-count")
    async getCharactersCount(@Body() payload: AnalyzerDto): Promise<number> {
        return await this.analyzerService.charactersCount(payload);
    }
    @Post("sentences-count")
    async getSentencesCount(@Body() payload: AnalyzerDto): Promise<number> {
        return await this.analyzerService.sentencesCount(payload);
    }
    @Post("paragraphs-count")
    async getParagraphsCount(@Body() payload: AnalyzerDto): Promise<number> {
        return await this.analyzerService.paragraphsCount(payload);
    }
    @Post("longest-word")
    async getLongestWord(@Body() payload: AnalyzerDto): Promise<string> {
